...
//Reader reader =new Reader("Mihail", "Vlad", "Mitr", "root", "1rootroot", "librarian", "222-33-44", new ArrayList<BookTransaction>(),new ArrayList<GregorianCalendar>());
...
//	Run.addReader(new Reader("Sergei", "Petrovich", "Kulik", "reader1", "123456a", "reader", "222-66-77",new ArrayList<BookTransaction>(), new ArrayList<GregorianCalendar>()));
//	Run.addReader(new Reader("Kol9n", "Pahanovich", "Saratov", "reader2", "123456a", "reader", "777-77-77",new ArrayList<BookTransaction>(), new ArrayList<GregorianCalendar>()));
//	Run.addReader(new Reader("Sergei", "Abramovich", "Aladov", "reader3", "123456a", "reader", "233-65-88",new ArrayList<BookTransaction>(), new ArrayList<GregorianCalendar>()));
//	Run.addReader(new Reader("Grigori", "Grigorevich", "Grishin", "reader4", "123456a", "reader", "559-66-55",new ArrayList<BookTransaction>(), new ArrayList<GregorianCalendar>()));
//	Run.addReader(new Reader("Nikolaevna", "Maria", "Petros9n", "reader5", "123456a", "reader", "363-52-89",new ArrayList<BookTransaction>(), new ArrayList<GregorianCalendar>()));
//	Run.addReader(new Reader("Skladovska9", "Maria", "Kuri", "reader2", "123456a", "reader", "777-77-77",new ArrayList<BookTransaction>(), new ArrayList<GregorianCalendar>()));
